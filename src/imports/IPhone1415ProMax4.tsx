import svgPaths from "./svg-cg0a0dhra7";

export default function IPhone1415ProMax() {
  return (
    <div className="bg-[#e4e4e4] relative size-full" data-name="iPhone 14 & 15 Pro Max - 4">
      <div className="absolute h-[932px] left-0 top-0 w-[430px]" data-name="Card 1">
        <video autoPlay className="absolute max-w-none object-cover size-full" controlsList="nodownload" loop playsInline>
          <source src="/_videos/v1/5c89a14a352924bcaf9679fadaf0e2fce7887a74" />
        </video>
      </div>
      <div className="absolute inset-[3.97%_8.37%_90.88%_80.47%]" data-name="Union">
        <div className="absolute inset-[-1.04%_-7.29%_-17.71%_-11.46%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 56.9991 56.9991">
            <g filter="url(#filter0_d_11_55)" id="Union">
