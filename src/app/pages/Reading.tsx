...
import { ReadingVideoOverlay } from "../components/ReadingVideoOverlay";
...
export default function Reading() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('reading-played-weeks');
    if (saved) {
  ...
  const handlePlayClick = (weekNumber: number) => {
    ...
    localStorage.setItem('reading-played-weeks', JSON.stringify(Array.from(newPlayedWeeks)));
    setIsVideoOpen(true);
  };
  ...
  const renderButton = (weekNumber: number, buttonStyles: string, rotationStyles?: string) => {
    ...
    const buttonContent = (
      <button 
        className={`block cursor-pointer ${buttonStyles} shadow-[inset_-2px_7px_5px_0px_rgba(0,0,0,0.1)] rounded-full ${isPlayed ? 'bg-[#7bbf60]' : 'bg-[#91d77f]'}`}
        onClick={() => handlePlayClick(weekNumber)}
      >
        {isPlayed ? (
          <div className="absolute flex inset-0 items-center justify-center">
            <Check className="w-12 h-12 text-[#1d6324] stroke-[3]" />
          </div>
        ) : (
          <div className="absolute flex inset-0 items-center justify-center">
              ...
              <div className="relative size-full">
                <div className="absolute bottom-1/4 left-[14%] right-[14%] top-[10%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 57.5931 52">
                    <path d={svgPaths.p19083cc0} fill="var(--fill-0, #499E3C)" />
                  </svg>
                </div>
              </div>
            </div>
    ...
    >
      <div className="relative w-[430px] h-[932px] overflow-hidden">
        ...
        <div className="absolute left-[-37.93px] top-[229.38px]">
          <div className="absolute flex h-[127.237px] items-center justify-center left-0 top-0 w-[327.851px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
            <div className="-rotate-2 flex-none">
              <div className="bg-[#499e3c] h-[116px] rounded-[25px] w-[324px]" style={{ boxShadow: '-4px 4px 6px rgba(0, 0, 0, 0.25)' }} />
            </div>
          </div>
          ...
          <div className="absolute bg-[#499e3c] h-[116px] left-[1.93px] rounded-[25px] top-[154px] w-[324px]" style={{ boxShadow: '-4px 4px 6px rgba(0, 0, 0, 0.25)' }} />
        </div>
        
        {/* Right side cards */}
        <div className="absolute left-[313px] top-[235px]">
          <div className="absolute bg-[#91d77f] h-[116px] left-0 rounded-[25px] top-0 w-[261px]" />
          <div className="absolute bg-[#91d77f] h-[116px] left-0 rounded-[25px] top-[148px] w-[261px]" />
          <div className="absolute bg-[#91d77f] h-[116px] left-0 rounded-[25px] top-[296px] w-[261px]" />
          <div className="absolute bg-[#91d77f] h-[116px] left-0 rounded-[25px] top-[444px] w-[261px]" />
        </div>
        ...
        <button onClick={() => navigate('/sewing')} className="absolute left-[43px] top-[852px] cursor-pointer hover:opacity-80 transition-opacity">
          <div className="absolute bg-[#91d77f] h-[42px] left-0 rounded-[25px] top-0 w-[57px]" />
          <p className="absolute font-['Icebox_Trial:Magnet'] leading-[normal] left-[25px] not-italic text-[#1d6324] text-[24px] top-[6px] whitespace-nowrap">1</p>
        </button>
        ...
        <button onClick={() => navigate('/car-repair')} className="absolute left-[100px] top-[852px] cursor-pointer hover:opacity-80 transition-opacity">
          <div className="absolute bg-[#91d77f] h-[42px] left-0 rounded-[25px] top-0 w-[57px]" />
          <p className="absolute font-['Icebox_Trial:Magnet'] leading-[normal] left-[22px] not-italic text-[#1d6324] text-[24px] top-[6px] whitespace-nowrap">2</p>
        </button>

        <button onClick={() => navigate('/')} className="absolute left-[157px] top-[852px] cursor-pointer hover:opacity-80">
          <div className="absolute bg-[#91d77f] h-[42px] left-0 rounded-[25px] top-0 w-[116px]" />
          <p className="absolute font-['Icebox_Trial:Magnet'] leading-[normal] left-[17px] not-italic text-[#1d6324] text-[24px] top-[6px] whitespace-nowrap">Hobbies</p>
        </button>

        <button onClick={() => navigate('/games')} className="absolute left-[273px] top-[852px] cursor-pointer hover:opacity-80 transition-opacity">
          <div className="absolute bg-[#91d77f] h-[42px] left-0 rounded-[25px] top-0 w-[57px]" />
          <p className="absolute font-['Icebox_Trial:Magnet'] leading-[normal] left-[22px] not-italic text-[#1d6324] text-[24px] top-[6px] whitespace-nowrap">3</p>
        </button>

        <div className="absolute left-[330px] top-[852px]">
          <div className="absolute bg-[#7bbf60] h-[42px] left-0 rounded-[25px] top-0 w-[57px]">
            <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_0px_7px_0px_rgba(0,0,0,0.25)]" />
          </div>
          <p className="absolute font-['Icebox_Trial:Bold'] leading-[normal] left-[22px] not-italic text-[#1d6324] text-[24px] top-[6px] whitespace-nowrap">4</p>
        </div>
      </div>
      <ReadingVideoOverlay isOpen={isVideoOpen} onClose={() => setIsVideoOpen(false)} />
    </motion.div>
  );
}