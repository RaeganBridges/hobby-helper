...
export default function Sewing() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('sewing-played-weeks');
    if (saved) {
  ...
  const handlePlayClick = (weekNumber: number) => {
    ...
    localStorage.setItem('sewing-played-weeks', JSON.stringify(Array.from(newPlayedWeeks)));
    setIsVideoOpen(true);
  };
  ...
  const renderButton = (weekNumber: number, buttonStyles: string, rotationStyles?: string) => {
    ...
    const buttonContent = (
      <button 
        className={`block cursor-pointer ${buttonStyles} shadow-[inset_-2px_7px_5px_0px_rgba(0,0,0,0.1)] rounded-full ${isPlayed ? 'bg-[#e8c547]' : 'bg-[#f9de87]'}`}
        onClick={() => handlePlayClick(weekNumber)}
      >
        {isPlayed ? (
          <div className="absolute flex inset-0 items-center justify-center">
            <Check className="w-12 h-12 text-[#8f6922] stroke-[3]" />
          </div>
        ) : (
          <div className="absolute flex inset-0 items-center justify-center">
    ...
    <>
      ...
      >
        <div className="relative w-[430px] h-[932px] overflow-hidden">
          <div className="absolute bg-[#ffefbc] h-[932px] left-0 opacity-35 rounded-[54px] top-0 w-[430px]">
            <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_0px_35px_-10px_rgba(0,0,0,0.1)]" />
          </div>
          <div className="absolute bg-[#ffdc69] h-[177px] left-0 rounded-[55px] top-0 w-[430px]">
          ...
          <div className="absolute left-[-37.93px] top-[229.38px]">
            <div className="absolute flex h-[127.237px] items-center justify-center left-0 top-0 w-[327.851px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
              <div className="-rotate-2 flex-none">
                <div className="bg-[#e8a719] h-[116px] rounded-[25px] w-[324px]" style={{ boxShadow: '-4px 4px 6px rgba(0, 0, 0, 0.25)' }} />
              </div>
            </div>
            ...
            <div className="absolute bg-[#e8a719] h-[116px] left-[1.93px] rounded-[25px] top-[154px] w-[324px]" style={{ boxShadow: '-4px 4px 6px rgba(0, 0, 0, 0.25)' }} />
          </div>
          ...
          {/* Title */}
          <p className="absolute font-['Icebox_Trial:Magnet'] leading-[normal] left-[104px] not-italic text-[#8f6922] text-[72px] top-[70px] whitespace-nowrap">SEWING</p>
          ...
          <div className="absolute flex h-[42.374px] items-center justify-center left-[18.39px] top-[247px] w-[127.249px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
            <div className="-rotate-2 flex-none">
              <p className="font-['Icebox_Trial:Magnet'] leading-[normal] not-italic relative text-[#fff9e8] text-[32px] whitespace-nowrap">WEEK ONE</p>
            </div>
          </div>
          <div className="absolute flex h-[54.522px] items-center justify-center left-[19.87px] top-[283.17px] w-[246.456px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
            <div className="-rotate-2 flex-none">
              <p className="font-['Carp_VF_Trial:Regular'] font-normal leading-[normal] relative text-[#fff9e8] text-[20px] w-[245px]" style={{ fontVariationSettings: "'wdth' 100" }}>
          ...
          {/* Week Two */}
          <p className="absolute font-['Icebox_Trial:Magnet'] leading-[normal] left-[19px] not-italic text-[#fff9e8] text-[32px] top-[396px] whitespace-nowrap">WEEK TWO</p>
          <p className="absolute font-['Carp_VF_Trial:Regular'] font-normal leading-[normal] left-[20px] text-[#fff9e8] text-[20px] top-[435px] w-[245px]" style={{ fontVariationSettings: "'wdth' 100" }}>
          ...
          <div className="absolute flex h-[43.351px] items-center justify-center left-[18.4px] top-[540.5px] w-[155.232px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
            <div className="flex-none rotate-2">
              <p className="font-['Icebox_Trial:Magnet'] leading-[normal] not-italic relative text-[#fff9e8] text-[32px] whitespace-nowrap">WEEK THREE</p>
            </div>
          </div>
          <div className="absolute flex h-[54.662px] items-center justify-center left-[19.31px] top-[578.67px] w-[250.454px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
            <div className="flex-none rotate-2">
              <p className="font-['Carp_VF_Trial:Regular'] font-normal leading-[normal] relative text-[#fff9e8] text-[20px] w-[249px]" style={{ fontVariationSettings: "'wdth' 100" }}>
          ...
          <div className="absolute flex h-[42.933px] items-center justify-center left-[18.39px] top-[689.3px] w-[143.24px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
            <div className="-rotate-2 flex-none">
              <p className="font-['Icebox_Trial:Magnet'] leading-[normal] not-italic relative text-[#fff9e8] text-[32px] whitespace-nowrap">WEEK FOUR</p>
            </div>
          </div>
          <div className="absolute flex h-[54.697px] items-center justify-center left-[18.24px] top-[725.65px] w-[251.453px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
            <div className="-rotate-2 flex-none">
              <p className="font-['Carp_VF_Trial:Regular'] font-normal leading-[normal] relative text-[#fff9e8] text-[20px] w-[250px]" style={{ fontVariationSettings: "'wdth' 100" }}>
          ...
          <div className="absolute left-[43px] top-[852px]">
            ...
            <p className="absolute font-['Icebox_Trial:Bold'] leading-[normal] left-[25px] not-italic text-[#6e4d11] text-[24px] top-[6px] whitespace-nowrap">1</p>
          </div>
          ...
          <button onClick={() => navigate('/car-repair')} className="absolute left-[100px] top-[852px] cursor-pointer hover:opacity-80 transition-opacity">
            ...
            <p className="absolute font-['Icebox_Trial:Magnet'] leading-[normal] left-[22px] not-italic text-[#8f6922] text-[24px] top-[6px] whitespace-nowrap">2</p>
          </button>
          ...
          <button onClick={() => navigate('/')} className="absolute left-[157px] top-[852px] cursor-pointer hover:opacity-80">
            ...
            <p className="absolute font-['Icebox_Trial:Magnet'] leading-[normal] left-[17px] not-italic text-[#8f6922] text-[24px] top-[6px] whitespace-nowrap">Hobbies</p>
          </button>

          <button onClick={() => navigate('/games')} className="absolute left-[273px] top-[852px] cursor-pointer hover:opacity-80 transition-opacity">
            <div className="absolute bg-[#ffdc69] h-[42px] left-0 rounded-[25px] top-0 w-[57px]" />
            <p className="absolute font-['Icebox_Trial:Magnet'] leading-[normal] left-[22px] not-italic text-[#8f6922] text-[24px] top-[6px] whitespace-nowrap">3</p>
          </button>
          ...
          <button onClick={() => navigate('/reading')} className="absolute left-[330px] top-[852px] cursor-pointer hover:opacity-80 transition-opacity">
            <div className="absolute bg-[#ffdc69] h-[42px] left-0 rounded-[25px] top-0 w-[57px]" />
            <p className="absolute font-['Icebox_Trial:Magnet'] leading-[normal] left-[22px] not-italic text-[#8f6922] text-[24px] top-[6px] whitespace-nowrap">4</p>
          </button>
        </div>
      </motion.div>
